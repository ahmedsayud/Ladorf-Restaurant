    ...
    <div className="space-y-6">
        ...
        <div className="flex gap-4 items-center">
          ...
          <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
            ...
            <DialogContent className="max-w-md max-h-[80vh]">
              ...
              <Button onClick={handleAddProduct} className="w-full bg-ladorf-600 hover:bg-ladorf-700 mt-4">
                إضافة المنتج
              </Button>
            </DialogContent>
          </Dialog>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="max-w-md max-h-[80vh]">
          ...
          <Button onClick={handleEditProduct} className="w-full bg-ladorf-600 hover:bg-ladorf-700 mt-4">
            حفظ التعديلات
          </Button>
        </DialogContent>
      </Dialog>
